...
})({"cifie":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "583094be2bcbcf3d";
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"7AO7J":[function(require,module,exports) {
/**
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var fourthSectionIn = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    var sixthSectionIn = (0, _gsap.gsap).timeline({
        scrollTrigger: {
...
},{"@studio-freight/lenis":"ljctC","gsap":"386gi","gsap/ScrollTrigger":"lSvcS","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"ljctC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function t(t, e) {
    for(var i = 0; i < e.length; i++){
        var o = e[i];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, "symbol" == (0, _typeOf._)(n = function(t, e) {
...
function i() {
    return i = Object.assign ? Object.assign.bind() : function i(t) {
        for(var e = 1; e < arguments.length; e++){
            var _$i = arguments[e];
            for(var o in _$i)Object.prototype.hasOwnProperty.call(_$i, o) && (t[o] = _$i[o]);
        }
        return t;
...
var n = /*#__PURE__*/ function() {
    ...
    return e.advance = function(t) {
        ...
        var o = i.lerp, n = void 0 === o ? .1 : o, s = i.duration, r = void 0 === s ? 1 : s, l = i.easing, h = void 0 === l ? function h(t) {
            return t;
        } : l, a = i.onUpdate;
    ...
    var t = function t(t) {
        var _$e, i, o = this, n = void 0 === t ? {} : t, s = n.wrapper, r = n.content, l = n.autoResize, h = void 0 === l || l;
        if (this.resize = function() {
            ...
            var a = (_$e = this.resize, function a() {
                var _$t = arguments, o = this;
    ...
    return t.prototype.destroy = function() {
        var t, _$e;
        null == (t = this.wrapperResizeObserver) || t.disconnect(), null == (_$e = this.contentResizeObserver) || _$e.disconnect();
    }, e(t, [
        {
            key: "limit",
            get: function get() {
    ...
    var t = function t(t, e) {
        ...
        this.onTouchStart = function(t) {
            var _$e = t.targetTouches ? t.targetTouches[0] : t, o = _$e.clientY;
            i.touchStart.x = _$e.clientX, i.touchStart.y = o, i.lastDelta = {
                x: 0,
                y: 0
            };
        }, this.onTouchMove = function(t) {
            var _$e = t.targetTouches ? t.targetTouches[0] : t, o = _$e.clientX, n = _$e.clientY, s = -(o - i.touchStart.x) * i.touchMultiplier, r = -(n - i.touchStart.y) * i.touchMultiplier;
            ...
            var _$e = t.deltaX, n = t.deltaY;
            i.normalizeWheel && (_$e = o(-100, _$e, 100), n = o(-100, n, 100)), i.emitter.emit("scroll", {
                type: "wheel",
                deltaX: _$e *= i.wheelMultiplier,
    ...
    var t = function t(t) {
        var _$e = this, o = void 0 === t ? {} : t, h = o.wrapper, a = void 0 === h ? window : h, c = o.content, u = void 0 === c ? document.documentElement : c, p = o.wheelEventsTarget, v = void 0 === p ? a : p, d = o.smoothWheel, m = void 0 === d || d, f = o.smoothTouch, g = void 0 !== f && f, S = o.syncTouch, y = void 0 !== S && S, w = o.syncTouchLerp, T = void 0 === w ? .1 : w, b = o.__iosNoInertiaSyncTouchLerp, z = void 0 === b ? .4 : b, M = o.touchInertiaMultiplier, E = void 0 === M ? 35 : M, L = o.duration, _ = o.easing, O = void 0 === _ ? function O(t) {
            return Math.min(1, 1.001 - Math.pow(2, -10 * t));
        } : _, R = o.lerp, W = void 0 === R ? L && .1 : R, k = o.infinite, x = void 0 !== k && k, H = o.orientation, j = void 0 === H ? "vertical" : H, A = o.gestureOrientation, X = void 0 === A ? "vertical" : A, Y = o.touchMultiplier, D = void 0 === Y ? 1 : Y, I = o.wheelMultiplier, P = void 0 === I ? 1 : I, C = o.normalizeWheel, U = void 0 !== C && C, N = o.autoResize, V = void 0 === N || N;
        this.onVirtualScroll = function(t) {
            var o = t.type, n = t.inertia, s = t.deltaX, r = t.deltaY, l = t.event;
            if (!l.ctrlKey) {
                var h = "touch" === o, a = "wheel" === o;
                if (!("vertical" === _$e.options.gestureOrientation && 0 === r || "horizontal" === _$e.options.gestureOrientation && 0 === s || h && "vertical" === _$e.options.gestureOrientation && 0 === _$e.scroll && !_$e.options.infinite && r <= 0 || l.composedPath().find(function(t) {
                    ...
                    if (_$e.isStopped || _$e.isLocked) l.preventDefault();
                    else {
                        if (_$e.isSmooth = (_$e.options.smoothTouch || _$e.options.syncTouch) && h || _$e.options.smoothWheel && a, !_$e.isSmooth) return _$e.isScrolling = !1, void _$e.animate.stop();
                        l.preventDefault();
                        var c = r;
                        "both" === _$e.options.gestureOrientation ? c = Math.abs(r) > Math.abs(s) ? r : s : "horizontal" === _$e.options.gestureOrientation && (c = s);
                        var u = h && _$e.options.syncTouch, p = h && n && Math.abs(c) > 1;
                        p && (c = _$e.velocity * _$e.options.touchInertiaMultiplier), _$e.scrollTo(_$e.targetScroll + c, i({
                            programmatic: !1
                        }, u && {
                            lerp: p ? _$e.syncTouchLerp : _$e.options.__iosNoInertiaSyncTouchLerp
                        }));
                    }
                }
            }
            ...
            if (!_$e.isScrolling) {
                var _$t = _$e.animatedScroll;
                _$e.animatedScroll = _$e.targetScroll = _$e.actualScroll, _$e.velocity = 0, _$e.direction = Math.sign(_$e.animatedScroll - _$t), _$e.emit();
            }
    ...
    return h.destroy = function() {
        ...
        var _$e = t - (this.time || t);
        this.time = t, this.animate.advance(.001 * _$e);
            ...
            if ("number" == typeof t) {
                ...
                this.animate.fromTo(this.animatedScroll, t, {
                    ...
                    onUpdate: function onUpdate(t, e) {
                        var _$o = e.completed;
                        c && (i.isLocked = !0), i.isScrolling = !0, i.velocity = t - i.animatedScroll, i.direction = Math.sign(i.velocity), i.animatedScroll = t, i.setScroll(i.scroll), T && (i.targetScroll = t), _$o && (c && (i.isLocked = !1), requestAnimationFrame(function() {
                            i.isScrolling = !1;
...
},{"@swc/helpers/_/_type_of":"7dHw6","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"386gi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}]},["cifie","7AO7J"], "7AO7J", "parcelRequire4ff8")
