  ...
  l = /*#__PURE__*/function () {
    function t(t) {
      var e = this,
        ...
        H = void 0 !== x && x,
        D = o.orientation,
        j = void 0 === D ? null != l ? l : "vertical" : D,
      ...
      this.onVirtualScroll = function (t) {
      ...
      }, l && console.warn("Lenis: `direction` option is deprecated, use `orientation` instead"), h && console.warn("Lenis: `gestureDirection` option is deprecated, use `gestureOrientation` instead"), a && console.warn("Lenis: `mouseMultiplier` option is deprecated, use `wheelMultiplier` instead"), c && console.warn("Lenis: `smooth` option is deprecated, use `smoothWheel` instead"), window.lenisVersion = "1.0.15", p !== document.documentElement && p !== document.body || (p = window), this.options = {
        wrapper: p,
        content: d,
        wheelEventsTarget: f,
        smoothWheel: S,
        ...
        content: d,
        autoResize: B
      }), this.rootElement.classList.add("lenis"), this.velocity = 0, this.isStopped = !1, this.isSmooth = S || y, this.isScrolling = !1, this.targetScroll = this.animatedScroll = this.actualScroll, this.animate = new n(), this.emitter = {
        events: {},
        emit: function (t) {
          for (var e = this.events[t] || [], i = 0, o = e.length; i < o; i++) e[i].apply(e, [].slice.call(arguments, 1));
        },
    ...
    return l.destroy = function () {
      ...
      if (!this.isStopped || void 0 !== w && w) {
        ...
        if ("number" == typeof t) {
          if (t += r, t = Math.round(t), this.options.infinite ? b && (this.targetScroll = this.animatedScroll = this.scroll) : t = o(0, t, this.limit), h) return this.animatedScroll = this.targetScroll = t, this.setScroll(this.scroll), this.reset(), this.emit(), void (null == S || S());
          if (!b) {
