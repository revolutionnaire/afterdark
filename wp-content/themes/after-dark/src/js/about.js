...
document.addEventListener(
	...
	function() {
		...
		// Setup scrollTo link.
		document.querySelector( '[href="#what-will-we-write"]' ).addEventListener(
			'click',
			function(event) {
		...
		secondSectionIn.from(
			'#content-what-will-we-write',
			{
				yPercent: -300,
				opacity: 0,
			}
