 ...
 * Guides REST API
 * ------------------------------------------------------------------------
 * This feature adds REST API endpoints for saving and deleting locations
 * in Guide custom posts.
 *
 * @class GuidesRESTAPI
 * @package Guides
 */
class Guides_REST_API {
	...
	/**
 	 * Function to enqueue inline JS for the Nonce.
 	 */
	...
	/**
 	 * Function used by the endpoint to save locations.
 	 *
 	 * @param $_POST $request The POST request sent to the API to be processed.
 	 * @return array
 	 */
	...
	/**
 	 * Function used by the endpoint to delete a location.
 	 *
 	 * @param $_POST $request The POST request sent to the API to be processed.
 	 * @return array
 	 */
	...
	/**
 	 * Function used by the endpoint check if the current user can edit posts.
 	 *
 	 * @return boolean
 	 */
